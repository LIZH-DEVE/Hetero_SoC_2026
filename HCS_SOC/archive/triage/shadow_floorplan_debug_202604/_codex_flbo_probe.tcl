...
foreach combo {{100 52 49 97} {100 52 48 97} {100 52 48 96} {100 53 48 97}} {
  lassign $combo live_top pocket_start data_bottom data_center_top
  open_checkpoint {D:/FPGAhanjia/Hetero_SoC_2026_3/Hetero_SoC_2026/HCS_SOC/HCS_SOC.runs/impl_1/udp_gateway_shadow_mirror_wrapper_routed.dcp}
  apply_geom $live_top $pocket_start $data_bottom $data_center_top
