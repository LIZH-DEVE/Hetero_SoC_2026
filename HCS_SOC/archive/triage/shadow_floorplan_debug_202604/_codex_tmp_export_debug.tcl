...
proc puts "DBG before force_auto_compile_order"`nforce_auto_compile_order`nputs "DBG after force_auto_compile_order projects=[get_projects -quiet] current=[current_project -quiet]" {} {
...
puts "DBG before open_project"`nopen_project -quiet $project_file`nputs "DBG after open_project projects=[get_projects -quiet] current=[current_project -quiet]"
puts "DBG before force_auto_compile_order"`nforce_auto_compile_order`nputs "DBG after force_auto_compile_order projects=[get_projects -quiet] current=[current_project -quiet]"
...
puts "DBG before raw_bd get_files"`nif {[llength [get_files -quiet $raw_bd]] != 0} {
