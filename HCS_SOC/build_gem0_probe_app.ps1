...
$sourceDir = Join-Path $workspace "gem0_probe_app\\src"
$buildDir = Join-Path $workspace "gem0_probe_app\\build"
...
Write-Host "Built gem0_probe_app:"
Write-Host (Join-Path $buildDir "gem0_probe_app.elf")
