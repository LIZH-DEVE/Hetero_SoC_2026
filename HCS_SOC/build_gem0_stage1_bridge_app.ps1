...
$sourceDir = Join-Path $workspace "gem0_stage1_bridge_app\\src"
$buildDir = Join-Path $workspace "gem0_stage1_bridge_app\\build"
...
Write-Host "Built gem0_stage1_bridge_app:"
Write-Host (Join-Path $buildDir "gem0_stage1_bridge_app.elf")
