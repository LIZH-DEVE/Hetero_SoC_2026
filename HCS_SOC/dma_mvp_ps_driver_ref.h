...
typedef struct {
    ...
    uint64_t recovery_active_cycles;
    uint64_t recovery_last_window_cycles;
    uint64_t recovery_max_window_cycles;
    uint64_t error_qualified_packet_count;
    uint64_t backend_total_cycles;
    uint64_t backend_accept_cycles;
    uint64_t backend_starvation_cycles;
