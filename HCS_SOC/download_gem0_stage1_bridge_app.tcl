...
set elf_file [file normalize [file join $workspace_root "gem0_stage1_bridge_app" "build" "gem0_stage1_bridge_app.elf"]]
...
if {![file exists $elf_file]} {
    error "missing gem0_stage1_bridge_app ELF: $elf_file (run build_gem0_stage1_bridge_app.ps1 first)"
}
