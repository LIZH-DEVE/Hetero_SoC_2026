...
$sourceDir = Join-Path $workspace "network_inject_app\\src"
$buildDir = Join-Path $workspace "network_inject_app\\build"
...
Write-Host "Built network_inject_app:"
Write-Host (Join-Path $buildDir "network_inject_app.elf")
