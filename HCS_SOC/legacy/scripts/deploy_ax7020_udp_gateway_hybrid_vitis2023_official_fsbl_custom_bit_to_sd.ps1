...
$imageDir = Join-Path $repoRoot "HCS_SOC\sd_boot\ax7020_udp_gateway_hybrid_vitis2023_official_fsbl_custom_bit"
...
$backupBoot = Join-Path $backupRoot ("BOOT_from_sd_before_hybrid_vitis2023_official_fsbl_custom_bit_{0}.bin" -f $timestamp)
