...
proc apply_ax7020_gem0_mio_config {} {
    # AX7020 board Ethernet wiring:
    #   RGMII: MIO16..27
    #   MDIO : MIO52..53
    # These writes are used as a targeted board bring-up override because the
    # exported ps7_init currently does not emit the ETH MIO mux configuration.
    foreach {addr value} {
...
set elf_file [file normalize [file join $workspace_root "gem0_probe_app" "build" "gem0_probe_app.elf"]]
...
if {![file exists $elf_file]} {
    error "missing gem0_probe_app ELF: $elf_file (run build_gem0_probe_app.ps1 first)"
}
