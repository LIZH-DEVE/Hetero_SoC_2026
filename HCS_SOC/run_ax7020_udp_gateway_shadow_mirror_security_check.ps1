...
$replyWhileLocked = Send-TestUdpPacket -LocalPort $lockedDataPort -RemotePort 4660
...
$replyAfterUnlock = Send-TestUdpPacket -LocalPort $unlockedDataPort -RemotePort 4660
...
$replyAfterReauth = Send-TestUdpPacket -LocalPort $reauthDataPort -RemotePort 4660
