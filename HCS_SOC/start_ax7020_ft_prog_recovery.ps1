...
$instructions = @(
    ...
    ("9. Write the fixed Xilinx User Area payload with: py -3 ""{0}"" --session-dir ""{1}"" --write --confirm-write" -f (Join-Path $PSScriptRoot "repair_ax7020_ftdi_user_area.py"), $userAreaSessionDir)
