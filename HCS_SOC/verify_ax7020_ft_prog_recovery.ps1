...
try {
if (-not $repairScript) {
    "User area repair script was not found locally; D2XX snapshot was skipped." | Set-Content -Path $d2xxLog -Encoding UTF8
    Write-Warning "User area repair script was not found locally; D2XX snapshot was skipped."
