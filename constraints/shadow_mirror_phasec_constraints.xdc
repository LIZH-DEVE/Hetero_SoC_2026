...
add_cells_to_pblock [get_pblocks shadow_data_region] [get_cells -quiet -hierarchical -filter {NAME =~ udp_gateway_shadow_mirror_i/dma_gateway_hybrid_0/inst/gen_shadow_inject_only.u_shadow_inject/s_axil_rdata*}]
...
add_cells_to_pblock [get_pblocks shadow_ctrl_region] [get_cells -quiet -hierarchical -filter {NAME =~ udp_gateway_shadow_mirror_i/dma_gateway_hybrid_0/inst/gen_shadow_inject_only.u_shadow_inject/* && NAME !~ udp_gateway_shadow_mirror_i/dma_gateway_hybrid_0/inst/gen_shadow_inject_only.u_shadow_inject/s_axil_rdata*}]
