...
### 2. SET_KEY
```powershell
py -3 .\tools\udp_crypto_control.py --ip 192.168.1.20 --source-ip 192.168.1.11 set-key --session-id <session_id> --binding-id 0x41583702 --algo aes
```
- Expect:
  - success exit code
...
### 3. STATUS
```powershell
py -3 .\tools\udp_crypto_control.py --ip 192.168.1.20 --source-ip 192.168.1.11 status --session-id <session_id> --binding-id 0x41583702
```
- Expect:
...
```powershell
py -3 .\tools\send_udp_crypto_test.py --algo aes --skip-control-session --expect-timeout
py -3 .\tools\send_udp_crypto_test.py --algo sm4 --skip-control-session --expect-timeout
```
- Expect:
...
```powershell
py -3 .\tools\send_udp_crypto_test.py --algo aes
py -3 .\tools\send_udp_crypto_test.py --algo aes --payload-hex <32-byte repeated AES block>
py -3 .\tools\run_udp_crypto_length_regression.py --ip 192.168.1.20 --source-ip 192.168.1.11 --algo aes --lengths 1472 --skip-invalid --skip-stress --timeout 6 --send-interval-ms 1

py -3 .\tools\send_udp_crypto_test.py --algo sm4
py -3 .\tools\send_udp_crypto_test.py --algo sm4 --payload-hex <32-byte repeated SM4 block>
py -3 .\tools\run_udp_crypto_length_regression.py --ip 192.168.1.20 --source-ip 192.168.1.11 --algo sm4 --lengths 1472 --skip-invalid --skip-stress --timeout 6 --send-interval-ms 1
```
- Expect:
  - `expected_match=1`
  - `result=PASS`
...
## Replay validation
```powershell
py -3 .\tools\run_udp_crypto_control_regression.py --ip 192.168.1.20 --source-ip 192.168.1.11
```
- Expect:
  - `CASE replay`
  - `replay_drop=1`
...
## BENCH validation
```powershell
py -3 .\tools\run_udp_crypto_control_regression.py --ip 192.168.1.20 --source-ip 192.168.1.11 --bench-repeats 8
```
