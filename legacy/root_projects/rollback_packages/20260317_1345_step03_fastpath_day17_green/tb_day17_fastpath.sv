...
module tb_day17_fastpath;
    ...
    task automatic present_non_fast_packet(
        input [15:0] port,
        input [15:0] length,
        input        acl_drop
    );
    ...
    initial begin
        ...
        clear_monitors();
        present_non_fast_packet(CRYPTO_PORT, 16'd32, 1'b0);
        ...
        clear_monitors();
        present_non_fast_packet(CONFIG_PORT, 16'd32, 1'b0);
        repeat (6) @(posedge clk);
        record_result(
            s_axis_tready == 1'b0 &&
            bypass_cnt == 32'd2 &&
        ...
        clear_monitors();
        present_non_fast_packet(16'h1235, 16'd32, 1'b1);
        repeat (6) @(posedge clk);
        record_result(
            s_axis_tready == 1'b0 &&
            bypass_cnt == 32'd2 &&
        ...
        clear_monitors();
        present_non_fast_packet(16'h1235, 16'd31, 1'b0);
        repeat (6) @(posedge clk);
        record_result(
            s_axis_tready == 1'b0 &&
            bypass_cnt == 32'd3 &&
        ...
        clear_monitors();
        present_non_fast_packet(16'h1235, 16'd0, 1'b0);
        repeat (6) @(posedge clk);
        record_result(
            s_axis_tready == 1'b0 &&
            bypass_cnt == 32'd4 &&
