...
module rx_parser #(
    ...
    // 状态机
    typedef enum logic [2:0] {IDLE, ETH_HDR, IP_HDR, UDP_HDR, PAYLOAD, ARP_PAYLOAD, DROP} state_t;
    state_t state;
    ...
    // Forward ARP payload words after the Ethernet header to the responder.
    assign o_arp_valid = (state == ARP_PAYLOAD) && s_axis_tvalid;
