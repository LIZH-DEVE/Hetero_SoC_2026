...
class DmaContractGenerationTests(unittest.TestCase):
    ...
    def test_manifest_freezes_key_contract_values(self):
        ...
        self.assertEqual(0xD4, manifest["csr"]["offsets"]["DEBUG_STATUS"])
        self.assertEqual(0xF0, manifest["csr"]["offsets"]["DEBUG_KEY_WORD0"])
        self.assertEqual(0xFC, manifest["csr"]["offsets"]["DEBUG_KEY_WORD3"])
        self.assertEqual(0x100, manifest["csr"]["offsets"]["COUNTER_CTRL"])
        self.assertEqual(0x104, manifest["csr"]["offsets"]["ROLLBACK_EVENT_COUNT_LO"])
        self.assertEqual(0x108, manifest["csr"]["offsets"]["ROLLBACK_EVENT_COUNT_HI"])
        self.assertEqual(0x150, manifest["csr"]["offsets"]["DROP_PULSE_COUNT_HI"])
        self.assertEqual(0x1, manifest["csr"]["write_values"]["RING_DOORBELL_KICK"])
        self.assertEqual(10, manifest["csr"]["ctrl_bits"]["SOFT_RESET"])
        self.assertEqual(0, manifest["csr"]["counter_ctrl_bits"]["CLEAR_ALL"])
        self.assertEqual(1, manifest["csr"]["counter_ctrl_bits"]["SNAPSHOT"])
        ...
        self.assertEqual(32, manifest["raw_copy"]["fifo_depth"])
    ...
    def test_generated_artifacts_surface_equivalent_contract_metadata(self):
        ...
        self.assertIn("#define DMA_CSR_DEBUG_STATUS 0x000000D4u", c_header)
        self.assertIn("#define DMA_CSR_DEBUG_KEY_WORD3 0x000000FCu", c_header)
        self.assertIn("#define DMA_CSR_COUNTER_CTRL 0x00000100u", c_header)
        self.assertIn("#define DMA_CSR_ROLLBACK_EVENT_COUNT_LO 0x00000104u", c_header)
        self.assertIn("#define DMA_CSR_DROP_PULSE_COUNT_HI 0x00000150u", c_header)
        self.assertIn("#define DMA_COUNTER_CTRL_BIT_CLEAR_ALL 0u", c_header)
        self.assertIn("#define DMA_COUNTER_CTRL_SNAPSHOT (1u << DMA_COUNTER_CTRL_BIT_SNAPSHOT)", c_header)
        ...
        self.assertIn("localparam logic [31:0] DMA_CSR_DEBUG_STATUS = 32'h000000D4;", sv_pkg)
        self.assertIn("localparam logic [31:0] DMA_CSR_DEBUG_KEY_WORD3 = 32'h000000FC;", sv_pkg)
        self.assertIn("localparam logic [31:0] DMA_CSR_COUNTER_CTRL = 32'h00000100;", sv_pkg)
        self.assertIn("localparam logic [31:0] DMA_CSR_ROLLBACK_EVENT_COUNT_LO = 32'h00000104;", sv_pkg)
        self.assertIn("localparam logic [31:0] DMA_CSR_DROP_PULSE_COUNT_HI = 32'h00000150;", sv_pkg)
        self.assertIn("localparam int unsigned DMA_COUNTER_CTRL_BIT_CLEAR_ALL = 0;", sv_pkg)
        self.assertIn("localparam logic [31:0] DMA_COUNTER_CTRL_SNAPSHOT = 32'h00000001 << DMA_COUNTER_CTRL_BIT_SNAPSHOT;", sv_pkg)
